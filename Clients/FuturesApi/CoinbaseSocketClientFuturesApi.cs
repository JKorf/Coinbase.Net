...
namespace Coinbase.Net.Clients.FuturesApi
{
    ...
    /// </summary>
    internal partial class CoinbaseSocketClientFuturesApi : SocketApiClient, ICoinbaseSocketClientFuturesApi
    {
        #region fields
        ...
        /// ctor
        /// </summary>
        internal CoinbaseSocketClientFuturesApi(ILogger logger, CoinbaseSocketOptions options) :
            base(logger, options.Environment.SocketClientPublicAddress!, options, options.FuturesOptions)
        {
        }
        #endregion 
        ...
        /// <inheritdoc />
        public ICoinbaseSocketClientFuturesApiShared SharedClient => this;
