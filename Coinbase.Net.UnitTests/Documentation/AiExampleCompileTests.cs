...
namespace Coinbase.Net.UnitTests.Documentation
{
    [TestFixture]
...
";
        ...
        private static string FindRepositoryRoot()
        {
            ...
            {
                if (File.Exists(Path.Combine(directory.FullName, "Coinbase.Net.sln")))
                    return directory.FullName;

                directory = directory.Parent;
            }

            throw new DirectoryNotFoundException("Could not find Coinbase.Net.sln in the current directory tree.");
        }
