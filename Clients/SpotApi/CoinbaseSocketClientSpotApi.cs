...
namespace Coinbase.Net.Clients.SpotApi
{
    ...
    /// </summary>
    internal partial class CoinbaseSocketClientSpotApi : SocketApiClient, ICoinbaseSocketClientSpotApi
    {
        #region fields
        ...
        /// ctor
        /// </summary>
        internal CoinbaseSocketClientSpotApi(ILogger logger, CoinbaseSocketOptions options) :
        ...
        /// <inheritdoc />
        public ICoinbaseSocketClientSpotApiShared SharedClient => this;
