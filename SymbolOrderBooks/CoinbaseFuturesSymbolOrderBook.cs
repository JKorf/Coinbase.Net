...
namespace Coinbase.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class CoinbaseFuturesSymbolOrderBook : SymbolOrderBook
    {
        ...
        public CoinbaseFuturesSymbolOrderBook(string symbol, Action<CoinbaseOrderBookOptions>? optionsDelegate = null)
        ...
        public CoinbaseFuturesSymbolOrderBook(
            string symbol,
            Action<CoinbaseOrderBookOptions>? optionsDelegate,
            ILoggerFactory? logger,
            ICoinbaseRestClient? restClient,
            ICoinbaseSocketClient? socketClient) : base(logger, "Coinbase", "Futures", symbol)
        {
