...
namespace Coinbase.Net.UnitTests
{
    ...
    public class SocketSubscriptionTests
    {
        ...
        public async Task ValidateSpotExchangeDataSubscriptions()
        {
            ...
            var tester = new SocketSubscriptionValidator<CoinbaseSocketClient>(client, "Subscriptions/AdvancedTrade", "wss://advanced-trade-ws.coinbase.com", "events.0", stjCompare: true);
            ...
            await tester.ValidateAsync<IEnumerable<CoinbaseTrade>>((client, handler) => client.AdvancedTradeApi.SubscribeToTradeUpdatesAsync("ETH-USDT", handler), "Trades", "events.0.trades");
            await tester.ValidateAsync<IEnumerable<CoinbaseStreamKline>>((client, handler) => client.AdvancedTradeApi.SubscribeToKlineUpdatesAsync("ETH-USDT", handler), "Klines", "events.0.candles");
            ...
            await tester.ValidateAsync<CoinbaseUserUpdate>((client, handler) => client.AdvancedTradeApi.SubscribeToUserUpdatesAsync(handler), "User", "events.0");
