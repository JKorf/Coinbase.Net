...
namespace Coinbase.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class CoinbaseSpotSymbolOrderBook : SymbolOrderBook
    {
        ...
        public CoinbaseSpotSymbolOrderBook(string symbol, Action<CoinbaseOrderBookOptions>? optionsDelegate = null)
        ...
        public CoinbaseSpotSymbolOrderBook(
            string symbol,
