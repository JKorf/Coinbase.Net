...
namespace Coinbase.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface ICoinbaseUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, CoinbaseCredentials credentials, CoinbaseEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        ICoinbaseRestClient GetRestClient(string userIdentifier, CoinbaseCredentials? credentials = null, CoinbaseEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        ICoinbaseSocketClient GetSocketClient(string userIdentifier, CoinbaseCredentials? credentials = null, CoinbaseEnvironment? environment = null);
    }
}